...
local tasklist_buttons = gears.table.join(
                     ...
                     awful.button({ }, 4, function () awful.client.focus.byidx(1) end), --滚轮切换窗口
...
awful.screen.connect_for_each_screen(function(s)
    ...
    mysystray.forced_width = 45
    --mysystray.forced_height = 75
    local mysystray_container = wibox.container.margin(mysystray, 0, 0, 3, 0)  -- 设置容器的边距 
...
awful.rules.rules = {
    ...
    { rule_any = {
        class = {
          ...
          "Plank",
          "QQ","TelegramDesktop",
          "Chromium","Google-chrome","Firefox-esr","Microsoft-edge",
          "org.remmina.Remmina",
